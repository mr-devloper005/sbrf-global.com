export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'sbrf-global',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Sbrf Global',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'sbrf-global.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://sbrf-global.com',
